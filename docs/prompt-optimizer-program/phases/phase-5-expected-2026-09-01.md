# Archived Phase 5 contract

Historical note: this file was the active Phase 5 contract on 2026-09-01. Its acceptance text is preserved below; current execution uses `../expected.md`.
