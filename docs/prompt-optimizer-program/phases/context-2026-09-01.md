# Archived context — 2026-09-01

Historical note: this file was the living context before exact-tree recovery. Its point-in-time claims and machine-local paths are retained as evidence; current execution uses `../context.md`.
