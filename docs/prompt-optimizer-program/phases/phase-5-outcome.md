...
- Historical one-container/two-view closure VSIX: 388 files, 684,331 bytes, SHA-256 `114fc30d850036d1ceb7cadea0845aa43b0e3f5e0dd1e416609cd071568ce245`. The sole Prompt Optimizer native-view artifact supersedes it; archive/source/hash facts are emitted by the canonical packager and reported in the final handoff. The cross-process verifier is the repository-level `scripts/verify-installed-restart.mjs`, and it removes its temporary profile in `finally`.
