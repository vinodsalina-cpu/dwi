...
- Final VSIX: 388 files, 684,180 bytes, SHA-256 `ff1b9035fec6e9cb6be70f72da486edff7472af5c72f209d2fb9d0ac44afa87d`; archive inspection contains the host, webview, session store, and production-fail-closed smoke confirmation gate. The cross-process verifier is the repository-level `scripts/verify-installed-restart.mjs`.
