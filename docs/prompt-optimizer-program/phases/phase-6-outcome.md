...
- The superseded one-container/two-view 388-file VSIX had SHA-256 `114fc30d850036d1ceb7cadea0845aa43b0e3f5e0dd1e416609cd071568ce245`. The current sole-view artifact is rebuilt from the exact clean tracked final commit, passes `pnpm verify:extension:restart` for native consent/approval, deterministic local save, same-profile restart/resume, optimizer-only reset, and Project Meta Context preservation, and is identified by the generated evidence record and final handoff. The verifier removes its disposable profile after completion.
